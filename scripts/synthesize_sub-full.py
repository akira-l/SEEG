            ...
            for key in keys: 
                ...
                for clip_idx in range(n_clips):
                    ...
                    for sub_word_meta in clip_words: 
                        ...
                        all_full_save_path = '../gesture_full-sub' 
                        sub_folder_save_name = 'sub_' + str(candi_ind_) 
                        sub_folder_save_path = os.path.join(all_full_save_path, 'sub_' + str(candi_ind_))  
                        if not os.path.exists(sub_folder_save_path): 
                            os.makedirs(sub_folder_save_path) 

                        create_video_and_save_single(
                                sub_folder_save_path, sub_duration_str, '',
                        ...
                        torch.save(target_dir_vec[start_ind:(start_ind+stay_ind)], 
                                       os.path.join(sub_folder_save_path, sub_duration_str+'.pt') )
 

                    create_video_and_save_single(
                            sub_folder_save_path, str(candi_ind_), '',
                            target_dir_vec,
                            mean_dir_vec, sentence, audio=clip_audio, aux_str=aux_str,
                            clipping_to_shortest_stream=True, delete_audio_file=False, save_flag=True)
